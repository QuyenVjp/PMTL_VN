...
> **Ref**: `design/04-execution-overlay/api/API_ROUTE_INVENTORY.md` cho API routes tương ứng.
...
- Ref: `design/03-domains/content/REFERENCES/LITTLE_HOUSE_SEO.md`, `design/02-platform-baseline/web-runtime/seo-geo/STRUCTURED_DATA.md`
...
**Nội dung:**
- Near-paper interface (xem `design/02-platform-baseline/web-runtime/ELDERLY_UX.md` + `design/03-domains/content/REFERENCES/LITTLE-HOUSE-SPEC.MD`)
