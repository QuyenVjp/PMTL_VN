...
- Bất kỳ row nào trong bảng trên dùng `outbox event -> async job` đều phải coi `design/04-execution-overlay/cross-module/OUTBOX_EVENT_TAXONOMY.md` là payload owner.
...
- route/request boundary owner: `design/04-execution-overlay/api/API_ROUTE_INVENTORY.md`
- env contract owner: `design/04-execution-overlay/repo/ENV_INVENTORY.md`
- outbox event envelope + payload taxonomy owner: `design/04-execution-overlay/cross-module/OUTBOX_EVENT_TAXONOMY.md`
- queue payload owner: `design/02-platform-baseline/optional-scale/BULLMQ_WORKER_ARCHITECTURE.md`
