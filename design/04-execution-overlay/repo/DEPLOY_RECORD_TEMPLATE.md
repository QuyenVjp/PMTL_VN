...
> Procedure owner: `design/02-platform-baseline/deploy-ops/DEPLOY_RUNBOOK.md`
> Gate owner: `design/02-platform-baseline/deploy-ops/CICD_DEPLOY_GATES.md`
> Restore evidence: `design/04-execution-overlay/repo/RESTORE_DRILL_LOG.md`
...
- Phase 1 canonical path:
  - `design/04-execution-overlay/repo/deploy-records/YYYY-MM-DD_HHmmss.md`
