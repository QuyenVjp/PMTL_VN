...
> **Secret rotation**: `design/02-platform-baseline/security-runtime/SECRET_MANAGEMENT.md`
> **Email provider**: `design/02-platform-baseline/security-runtime/EMAIL_PROVIDER_DECISION.md`
> **Cache topology**: `design/02-platform-baseline/data-runtime/CACHE_TOPOLOGY.md`
> **Valkey**: `design/02-platform-baseline/optional-scale/VALKEY_ARCHITECTURE.md`
...
File này dùng cùng 4 lớp credential với `design/02-platform-baseline/security-runtime/SECRET_MANAGEMENT.md`.
...
> Design: `design/02-platform-baseline/optional-scale/VALKEY_ARCHITECTURE.md`
...
### Outbox dispatcher
> Design: `design/02-platform-baseline/optional-scale/OUTBOX_DISPATCHER_MODEL.md`
...
### Meilisearch
> Design: `design/02-platform-baseline/optional-scale/MEILISEARCH_ARCHITECTURE.md`
...
### Web Push (VAPID)
> Design: `design/02-platform-baseline/optional-scale/PUSH_NOTIFICATION_ARCHITECTURE.md`
...
> Design: `design/02-platform-baseline/data-runtime/CACHE_TOPOLOGY.md`
...
> Design: `design/02-platform-baseline/edge-delivery/WAF_ANTIBOT_STRATEGY.md`
...
> Design: `design/02-platform-baseline/deploy-ops/OBSERVABILITY_ARCHITECTURE.md`
...
> Design: `design/02-platform-baseline/deploy-ops/CICD_DEPLOY_GATES.md`
