...
| `Governance` | `covered` | source priority, taxonomy, conflict resolution, import boundaries, implementation status, version/runtime entrypoint đã thành chain đọc tương đối kín | `design/00-governance/SOURCE_PRIORITY.md`, `design/00-governance/CONFLICT_RESOLUTION.md`, `design/01-repo-constitution/ROOT_DOC_OWNERSHIP.md`, `design/02-platform-baseline/dependency-version/VERSION_MATRIX.md` |
