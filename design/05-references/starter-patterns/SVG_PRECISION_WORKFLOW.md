...
- mockup SVG nhẹ để minh họa `design/02-platform-baseline/web-runtime/` hoặc `design/04-execution-overlay/web/` mà cần commit/diff rõ ràng
...
- `design/assets/svg/`:
  ...
  - symbol
  - reusable primitives
- `design/01-repo-constitution/svg/`:
  - architecture topology
  - execution map variants
- `design/02-platform-baseline/web-runtime/svg/`:
  - mockup tĩnh
  - layout studies
  - component anatomy
...
Trong `design/02-platform-baseline/web-runtime/` và `design/04-execution-overlay/web/`, skill này đặc biệt hợp cho:
- icon studies
...
Trong `design/01-repo-constitution/` và các module `design/03-domains/*/`:
