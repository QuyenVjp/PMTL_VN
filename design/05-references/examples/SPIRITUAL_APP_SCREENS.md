...
>
> **Ref**: `design/02-platform-baseline/web-runtime/DESIGN_PRINCIPLES.md` (tokens), `design/04-execution-overlay/web/USER_FLOWS.md` (journeys), `design/02-platform-baseline/web-runtime/COMPONENT_SPECS.md` (components)

---

## Tổng quan màn hình

> **Route authority**: Routes dưới đây phải khớp với `design/04-execution-overlay/web/PAGE_INVENTORY.md` — file đó là canonical owner. Nếu có mâu thuẫn, PAGE_INVENTORY.md thắng.
