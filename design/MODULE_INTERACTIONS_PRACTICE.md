...
| Engagement | Notification | Notification owns delivery | reminder đọc/đếm bài | async job | push nhắc theo giờ |
| Vows & Merit | Calendar | Calendar owns ngày tu học | gợi ý ngày phát nguyện/phóng sanh | direct read | build reminder candidates |
| Vows & Merit | Notification | Notification owns delivery | đến hạn vow, ngày phóng sanh | async job | push/email reminder |
| Vows & Merit | Content | Content owns lời khấn/bài đọc | mở checklist phóng sanh | direct read | không write ngược |
| Wisdom & QA | Content | Content owns canonical source entry | đọc Bạch thoại / khai thị | direct read | offline bundle build |
