...
## Purpose
- Đồng bộ một bài viết đã publish từ content owner sang search index theo queue-first flow (luồng ưu tiên qua hàng đợi xử lý).
...
1. worker (tiến trình xử lý nền) nhận job search sync.
