...
> Web query canon: `design/tracking/web-query-invalidation-plan.md`
> App Router files: `design/tracking/web-app-router-file-contract.md`
> Global cache doctrine: `design/baseline/cache-topology.md`
