...
> Architecture baseline: `design/baseline/frontend-architecture.md`
> Web rebuild blueprint: `design/tracking/web-rebuild-blueprint.md`
> Page routes: `design/ui/PAGE_INVENTORY.md`
> Loader contracts: `design/tracking/page-loader-contracts.md`
...
- heading/body/sacred/mono mapping phải bám `design/ui/DESIGN_PRINCIPLES.md`.
