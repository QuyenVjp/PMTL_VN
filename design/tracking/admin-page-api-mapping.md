...
| `/admin/noi-dung/bai-hoa` | `/api/admin/wisdom/entries*`, `/api/admin/wisdom/baihua/*`, `/api/admin/wisdom/offline-bundles*`, `/api/admin/wisdom/import-jobs` | `['admin-wisdom', 'list', filters]`, `['admin-wisdom', 'detail', publicId]`, `['admin-wisdom', 'offline-bundles']`, `['admin-wisdom', 'import-jobs']`, `['admin-baihua-books', 'list', filters]`, `['admin-baihua-chapter', 'detail', publicId]` | create/update/publish/ingest/rebuild: invalidate wisdom list + detail + import-jobs + offline-bundles; baihua translation/publish còn invalidate admin chapter detail + search/offline freshness widgets nếu surfaced |
