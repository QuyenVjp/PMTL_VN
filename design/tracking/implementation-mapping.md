...
| `Meilisearch` | `apps/api/src/modules/search/adapters/meilisearch.adapter.ts`; feature flag: `search.meilisearch.enabled` | planned | SQL search p95 > 500ms OR multi-type search requirement xuất hiện rõ | `06-search/meilisearch-architecture.md` |
