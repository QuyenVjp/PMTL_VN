...
> - không dùng Redis pub/sub thuần làm handoff cho search/notify/email/webhook quan trọng
...
│ - Redis         │        │ - dispatcher                         │
│ - Meilisearch   │        │ - Redis execution queue             │
...
- single VPS
- `BullMQ` cho Redis-based execution queue
...
- app-layer rate limit bằng Redis
