...
- đọc theo thứ tự:
  - [ROOT_DOC_OWNERSHIP.md](../../01-repo-constitution/ROOT_DOC_OWNERSHIP.md)
  - [NEST_INTERNALS_POLICY.md](../../02-platform-baseline/api-runtime/NEST_INTERNALS_POLICY.md)
  - [PLATFORM_MODULES.md](../../02-platform-baseline/api-runtime/PLATFORM_MODULES.md)
...
- đọc:
  ...
  - [TRANSPORT_RUNTIME_POLICY.md](../../02-platform-baseline/api-runtime/TRANSPORT_RUNTIME_POLICY.md)
...
- đọc:
  - [MEILISEARCH_ARCHITECTURE.md](../../02-platform-baseline/optional-scale/MEILISEARCH_ARCHITECTURE.md)
  - [ERROR_CODE_REGISTRY.md](../../04-execution-overlay/api/ERROR_CODE_REGISTRY.md)
- rules:
