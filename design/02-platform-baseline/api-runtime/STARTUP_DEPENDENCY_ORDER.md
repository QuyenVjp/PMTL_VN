...
Trigger migrate sang Valkey khi: volume đủ lớn hoặc lock contention trên table đo được theo ngưỡng trong `design/02-platform-baseline/optional-scale/VALKEY_ARCHITECTURE.md`.
