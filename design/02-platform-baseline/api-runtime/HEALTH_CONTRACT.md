...
> **Full observability design**: `design/02-platform-baseline/deploy-ops/OBSERVABILITY_ARCHITECTURE.md`
> **Startup order**: `design/02-platform-baseline/api-runtime/STARTUP_DEPENDENCY_ORDER.md`
> **Deploy runbook**: `design/02-platform-baseline/deploy-ops/DEPLOY_RUNBOOK.md`
...
`/health/startup` chỉ track **11 baseline platform modules** từ `design/02-platform-baseline/api-runtime/STARTUP_DEPENDENCY_ORDER.md`.
