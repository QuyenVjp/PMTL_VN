...
>
> Đọc cùng:
> - `design/03-domains/content/REFERENCES/LITTLE_HOUSE_SEO.md` — SEO riêng cho Ngôi Nhà Nhỏ
> - `design/02-platform-baseline/web-runtime/seo-geo/STRUCTURED_DATA.md` — Schema.org toàn site
> - `design/02-platform-baseline/web-runtime/seo-geo/GEO_CITATION_STRATEGY.md` — GEO cho AI engines
> - `design/02-platform-baseline/web-runtime/seo-geo/CONTENT_CLUSTER_MAP.md` — Cây content cluster
...
Phân tích `design/05-references/external-research/deep-research-report.md` xác nhận phapmontamlinh.vn:
...
Xem `design/02-platform-baseline/web-runtime/seo-geo/CONTENT_CLUSTER_MAP.md` cho chi tiết.
