...
Trong `design/02-platform-baseline/web-runtime/` và `design/04-execution-overlay/web/`, dùng `svg-precision` cho:
- icon studies
...
Ref workflow: `design/05-references/starter-patterns/SVG_PRECISION_WORKFLOW.md`
...
Chi tiết admin architecture: `design/02-platform-baseline/admin-runtime/ADMIN_ARCHITECTURE.md`
