...
> **Ref**: `design/04-execution-overlay/web/PAGE_INVENTORY.md` (route list), `design/04-execution-overlay/web/USER_FLOWS.md` (journeys), `design/05-references/examples/SPIRITUAL_APP_SCREENS.md` (screen specs)
> **Rule**: Khi đổi route string, cập nhật `design/04-execution-overlay/web/PAGE_INVENTORY.md` trước. File này chốt IA, nav behavior, deep-linking, và gating rules bám theo route canon đó.
