...
> **Restore**: `design/02-platform-baseline/deploy-ops/BACKUP_RESTORE.md`
> **Migration**: `design/02-platform-baseline/data-runtime/MIGRATION_STRATEGY.md`
...
- deploy record canon phải theo `design/04-execution-overlay/repo/DEPLOY_RECORD_TEMPLATE.md`

## Deploy record pinning

- Sau mỗi production deploy, operator phải tạo hoặc cập nhật đúng `1` deploy record theo `design/04-execution-overlay/repo/DEPLOY_RECORD_TEMPLATE.md`.
