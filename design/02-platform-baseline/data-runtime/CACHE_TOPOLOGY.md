...
**Rule**: invalidation chain phải chạy từ canonical event taxonomy trong `design/04-execution-overlay/cross-module/OUTBOX_EVENT_TAXONOMY.md`; không tự nghĩ thêm event string ở từng layer cache.
...
> Full Valkey design: `design/02-platform-baseline/optional-scale/VALKEY_ARCHITECTURE.md`
