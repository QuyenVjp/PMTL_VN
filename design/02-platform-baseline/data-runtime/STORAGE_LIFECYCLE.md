...
> **Upload policy**: `design/02-platform-baseline/security-runtime/SECURITY_POLICY.md` — upload hardening
> **R2 migration**: `design/02-platform-baseline/optional-scale/R2_MIGRATION_PLAN.md`
