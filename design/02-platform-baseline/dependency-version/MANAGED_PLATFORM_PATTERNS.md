...
- `design/02-platform-baseline/security-runtime/SECRET_MANAGEMENT.md`
- `design/02-platform-baseline/deploy-ops/OBSERVABILITY_ARCHITECTURE.md`
- `design/02-platform-baseline/data-runtime/STORAGE_LIFECYCLE.md`
...
- dùng đây như review lens cho explicit authz checks đã được owner ở `design/02-platform-baseline/security-runtime/SECURITY_POLICY.md` và `design/01-repo-constitution/DECISIONS.md`
...
3. Dùng “policy-first authz” như review lens cho các authz rules đã owner ở `design/02-platform-baseline/security-runtime/SECURITY_POLICY.md`.
