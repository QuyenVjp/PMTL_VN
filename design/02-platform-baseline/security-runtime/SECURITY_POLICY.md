...
> Xem `design/04-execution-overlay/repo/CODING_READINESS.md` Phần 5 cho exact values từng endpoint.
...
Matrix này là `edge-first budget` cho Cloudflare/WAF. Nó không thay thế app-layer rate limit canon ở `design/04-execution-overlay/repo/CODING_READINESS.md`.
