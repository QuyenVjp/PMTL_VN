...
> **Env vars**: `design/04-execution-overlay/repo/ENV_INVENTORY.md` — SMTP_* group
> **Auth flow**: `design/03-domains/identity/USE_CASES/manage-auth-session.md`
> **Notification**: `design/03-domains/notification/` (push là separate concern)
...
**Push notification** (welcome, practice reminders) → Web Push (VAPID), NOT email. Xem `design/02-platform-baseline/optional-scale/PUSH_NOTIFICATION_ARCHITECTURE.md`.
