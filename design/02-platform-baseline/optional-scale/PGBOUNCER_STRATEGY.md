...
> **Phase trigger**: `design/02-platform-baseline/edge-delivery/INFRA_BASELINE.md` — "PgBouncer: connection count > threshold"
> **Env vars**: `design/04-execution-overlay/repo/ENV_INVENTORY.md` — DATABASE_URL, PGBOUNCER_URL group
