...
> **Storage abstraction**: `design/04-execution-overlay/repo/IMPLEMENTATION_MAPPING.md` — local adapter
> **Upload policy**: `design/02-platform-baseline/security-runtime/SECURITY_POLICY.md` — upload hardening rules
> **Infra**: `design/02-platform-baseline/edge-delivery/INFRA_BASELINE.md` — "Cloudflare R2: Phase 2+" entry
...
| Media volume mount fail gây 2+ restore drill fail | `design/04-execution-overlay/repo/RESTORE_DRILL_LOG.md` |
