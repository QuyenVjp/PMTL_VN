...
> **Event taxonomy**: `design/04-execution-overlay/cross-module/OUTBOX_EVENT_TAXONOMY.md` — which events go to outbox
> **BullMQ**: `design/02-platform-baseline/optional-scale/BULLMQ_WORKER_ARCHITECTURE.md` — queue consumer design
> **Env vars**: `design/04-execution-overlay/repo/ENV_INVENTORY.md` — OUTBOX_* group
> **Audit**: audit event `queue.job.dead_lettered` per `design/04-execution-overlay/api/AUDIT_POLICY.md`
