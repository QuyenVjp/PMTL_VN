...
> **BullMQ**: `design/02-platform-baseline/optional-scale/BULLMQ_WORKER_ARCHITECTURE.md` — `pmtl:search-sync` queue
> **Env vars**: `design/04-execution-overlay/repo/ENV_INVENTORY.md` — MEILISEARCH_* group
> **Search decisions**: `design/03-domains/search/decisions.md` — architectural rationale
...
| Trigger | Measurement |
|---|---|
| SQL search p95 vượt SLO | Pino logs / metrics showing public search p95 vượt SLO trong `design/02-platform-baseline/deploy-ops/SLA_SLO.md` |
