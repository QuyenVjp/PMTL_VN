...
- **Phase 2+**: notification hoặc moderation alert quan trọng nên đi qua `outbox_events`. **Phase 1**: dùng sync hoặc fire-and-forget có log intent + log outcome + retry/alert/manual-recovery path rõ.
