...
- Không tự thêm role mới như `editor` hoặc `moderator` nếu design chưa chốt. Role mới chỉ được thêm khi có doc explicit trong `design/03-domains/identity/DECISIONS.md` hoặc decision owner tương đương của identity.
