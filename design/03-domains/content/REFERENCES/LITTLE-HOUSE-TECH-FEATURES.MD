...
>
> Đọc cùng:
> - `design/03-domains/content/REFERENCES/LITTLE-HOUSE-EXPERIENCE-ARCHITECTURE.MD` — kiến trúc tổng thể
> - `design/03-domains/content/REFERENCES/LITTLE-HOUSE-SPEC.MD` — spec flow và validation
> - `design/03-domains/engagement/SCHEMA_PLAN.dbml` — engagement schema
> - `design/03-domains/calendar/SCHEMA_PLAN.dbml` — lunar calendar schema
