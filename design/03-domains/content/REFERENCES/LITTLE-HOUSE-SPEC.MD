...
>
> - `design/03-domains/engagement/SCHEMA_PLAN.dbml` — schema đã có 9 fields mới + 3 enums (recipient_type, burning_mode, preparation_state)
> - `design/03-domains/engagement/USE_CASES/manage-ngoi-nha-nho-sheet.md`
> - `design/03-domains/content/REFERENCES/LITTLE-HOUSE-EXPERIENCE-ARCHITECTURE.MD` — kiến trúc trải nghiệm đầy đủ
> - `design/03-domains/content/REFERENCES/LITTLE-HOUSE-CONTENT-INVENTORY.MD` — canonical content 13→5 nhóm
> - `design/03-domains/content/REFERENCES/LITTLE-HOUSE-TECH-FEATURES.MD` — 8 tech features spec
> - `design/03-domains/content/REFERENCES/LITTLE_HOUSE_SEO.md` — SEO keyword strategy và schema markup
...
- `design/03-domains/content/practice-pdf-extracts/6-phuong-phap-tung-niem-ngoi-nha-nho-va-nhung-ieu-can-luu-y/document.md`
- `design/03-domains/content/practice-pdf-extracts/7-quy-trinh-ot-ngoi-nha-nho-khong-co-ban-tho-pmtl/document.md`
