...
- `primary_source_ref`: `design/03-domains/content/REFERENCES/PRACTICE-SUPPORT-REFERENCE.MD#5-nghi-thức-phóng-sinh`
- `supporting_source_ref`: `design/03-domains/content/REFERENCES/LIFE-RELEASE-CONTENT-INVENTORY.MD#8-xử-lý-khi-có-loài-vật-tử-vong`
