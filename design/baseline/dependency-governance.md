...
Nó không thay thế quyết định công nghệ trong `design/DECISIONS.md`.
Nó bổ sung phần còn thiếu: cơ chế governance để tránh hai cực đoan:

- “giữ stack cũ quá lâu”
- “thấy bản mới là nâng tất cả”

> **Library choices authority**: `design/DECISIONS.md` section 14
> **Deferred / excluded technology authority**: `design/DECISIONS.md` section 15
> **Anti-goals authority**: `design/DECISIONS.md` section 17
> **Monorepo boundaries authority**: `AGENTS.md`
> **Migration baseline**: `design/baseline/migration-strategy.md`
> **CI/CD gates**: `design/baseline/cicd-deploy-gates.md`
> **Security baseline**: `design/baseline/security.md`
...
| pgvector | forbidden until reconsideration trigger | explicit exclusion | do not add | see `baseline/pgvector-decision.md` |
...
| CI/CD dependency changes | read `baseline/cicd-deploy-gates.md` and verify workflow assumptions stay valid |
...
- [ ] re-check `design/baseline/frontend-architecture.md` for cache and request-boundary rules
...
- [ ] confirm phase trigger in `design/baseline/observability-architecture.md`
