...
- nếu cần giải thích feature surface lấy từ source chính thức, dùng thêm `design/05-references/external-research/SOURCE_ANALYSIS.md`; file này chỉ chốt terminology, không thay file source-analysis
