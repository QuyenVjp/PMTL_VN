...
> **Ref**: `design/05-references/external-research/FIVE_TREASURES.md`, `design/04-execution-overlay/web/USER_FLOWS.md`, `design/05-references/examples/SPIRITUAL_APP_SCREENS.md`
...
> **Route authority**: `design/04-execution-overlay/web/PAGE_INVENTORY.md` — mọi route dưới đây phải khớp với file đó.
