...
| `design/02-platform-baseline/api-runtime/NESTJS_11_ADOPTION.md` | NestJS 11 feature adoption owner | exact scaffold line, Express v5 route stance, logger policy, selective use/defer list for Nest 11 capabilities | không thay request pipeline hay repo phase rules một mình |
