/**
 * Tag input components with optional autocomplete suggestions.
 *
 * Two variants:
 * - InputTags: Simple tag input with Enter/Backspace support
 * - InputTagsWithSuggestions: Tag input with filterable dropdown
 *
 * Ported from Shadboard, adapted for PMTL admin:
 * - Removed "use client" (Vite SPA)
 * - Vietnamese empty state text
 */
